...
TYPE AS gpointer GArray_autoptr
TYPE AS gpointer GAsyncQueue_autoptr
TYPE AS gpointer GBookmarkFile_autoptr
TYPE AS gpointer GByteArray_autoptr
TYPE AS gpointer GBytes_autoptr
TYPE AS gpointer GChecksum_autoptr
TYPE AS guint8 GDateDay
TYPE AS gpointer GDateTime_autoptr
TYPE AS guint16 GDateYear
TYPE AS gpointer GDir_autoptr
TYPE AS gpointer GError_autoptr
TYPE AS gpointer GHashTable_autoptr
TYPE AS gpointer GHmac_autoptr
TYPE AS gpointer GIOChannel_autoptr
TYPE AS gpointer GKeyFile_autoptr
TYPE AS gpointer GList_autoptr
TYPE AS gpointer GMainContext_autoptr
TYPE AS gpointer GMainLoop_autoptr
TYPE AS gpointer GMappedFile_autoptr
TYPE AS gpointer GMarkupParseContext_autoptr
TYPE AS gpointer GMatchInfo_autoptr
TYPE AS gpointer GMutexLocker
TYPE AS gpointer GMutexLocker_autoptr
TYPE AS gpointer GNode_autoptr
TYPE AS gpointer GOptionContext_autoptr
TYPE AS gpointer GOptionGroup_autoptr
TYPE AS gpointer GPatternSpec_autoptr
TYPE AS gint /'int'/ GPid
TYPE AS gpointer GPtrArray_autoptr
TYPE AS guint32 GQuark
TYPE AS gpointer GQueue_autoptr
TYPE AS gpointer GRand_autoptr
TYPE AS gpointer GRegex_autoptr
TYPE AS gpointer GSList_autoptr
TYPE AS gpointer GScanner_autoptr
TYPE AS gpointer GSequence_autoptr
TYPE AS gpointer GSource_autoptr
TYPE AS gpointer GStringChunk_autoptr
TYPE AS gpointer GString_autoptr
TYPE AS gpointer GStrv
TYPE AS gpointer GThread_autoptr
TYPE AS gint32 GTime
TYPE AS gint64 GTimeSpan
TYPE AS gpointer GTimeZone_autoptr
TYPE AS gpointer GTimer_autoptr
TYPE AS gpointer GTree_autoptr
TYPE AS gsize GType
TYPE AS gpointer GVariantBuilder_autoptr
TYPE AS gpointer GVariantDict_autoptr
TYPE AS gpointer GVariantIter_autoptr
TYPE AS gpointer GVariantType_autoptr
TYPE AS gpointer GVariant_autoptr
...
DECLARE FUNCTION g_compute_hmac_for_data(BYVAL AS GChecksumType, BYVAL AS guchar PTR, BYVAL AS gsize, BYVAL AS const guchar PTR, BYVAL AS gsize) AS gchar PTR
