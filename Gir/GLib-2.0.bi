...
' Auto-translated from file ../gir-1.0/GLib-2.0.gir
...
TYPE AS gpointer GMutexLocker
TYPE AS gint /'int'/ GPid
TYPE AS guint32 GQuark
TYPE AS gpointer GStrv
...
END ENUM
#DEFINE G_SEARCHPATH_SEPARATOR 59
...
TYPE _GArray
  ...
  AS guint len
END TYPE
DECLARE FUNCTION g_array_append_vals(BYVAL AS guint, BYVAL AS gconstpointer, BYVAL AS guint) AS guint
DECLARE FUNCTION g_array_free(BYVAL AS guint, BYVAL AS gboolean) AS gchar PTR
DECLARE FUNCTION g_array_get_element_size(BYVAL AS guint) AS guint
DECLARE FUNCTION g_array_insert_vals(BYVAL AS guint, BYVAL AS guint, BYVAL AS gconstpointer, BYVAL AS guint) AS guint
DECLARE FUNCTION g_array_new(BYVAL AS gboolean, BYVAL AS gboolean, BYVAL AS guint) AS guint
DECLARE FUNCTION g_array_prepend_vals(BYVAL AS guint, BYVAL AS gconstpointer, BYVAL AS guint) AS guint
DECLARE FUNCTION g_array_ref(BYVAL AS guint) AS guint
DECLARE FUNCTION g_array_remove_index(BYVAL AS guint, BYVAL AS guint) AS guint
DECLARE FUNCTION g_array_remove_index_fast(BYVAL AS guint, BYVAL AS guint) AS guint
DECLARE FUNCTION g_array_remove_range(BYVAL AS guint, BYVAL AS guint, BYVAL AS guint) AS guint
DECLARE SUB g_array_set_clear_func(BYVAL AS guint, BYVAL AS GDestroyNotify)
DECLARE FUNCTION g_array_set_size(BYVAL AS guint, BYVAL AS guint) AS guint
DECLARE FUNCTION g_array_sized_new(BYVAL AS gboolean, BYVAL AS gboolean, BYVAL AS guint, BYVAL AS guint) AS guint
DECLARE SUB g_array_sort(BYVAL AS guint, BYVAL AS GCompareFunc)
DECLARE SUB g_array_sort_with_data(BYVAL AS guint, BYVAL AS GCompareDataFunc, BYVAL AS gpointer)
DECLARE SUB g_array_unref(BYVAL AS guint)
...
DECLARE FUNCTION g_bookmark_file_load_from_data_dirs(BYVAL AS GBookmarkFile PTR, BYVAL AS gchar PTR, BYVAL AS gchar PTR PTR, BYVAL AS GError PTR PTR) AS gboolean
DECLARE FUNCTION g_bookmark_file_load_from_file(BYVAL AS GBookmarkFile PTR, BYVAL AS gchar PTR, BYVAL AS GError PTR PTR) AS gboolean
...
DECLARE FUNCTION g_bookmark_file_to_file(BYVAL AS GBookmarkFile PTR, BYVAL AS gchar PTR, BYVAL AS GError PTR PTR) AS gboolean
...
TYPE _GByteArray
  ...
  AS guint len
END TYPE
DECLARE FUNCTION g_byte_array_append(BYVAL AS gchar PTR PTR, BYVAL AS const guint8 PTR, BYVAL AS guint) AS gchar PTR PTR
DECLARE FUNCTION g_byte_array_free(BYVAL AS gchar PTR PTR, BYVAL AS gboolean) AS guint8 PTR
DECLARE FUNCTION g_byte_array_free_to_bytes(BYVAL AS gchar PTR PTR) AS GBytes PTR
DECLARE FUNCTION g_byte_array_new() AS gchar PTR PTR
DECLARE FUNCTION g_byte_array_new_take(BYVAL AS guint8 PTR, BYVAL AS gsize) AS gchar PTR PTR
DECLARE FUNCTION g_byte_array_prepend(BYVAL AS guint8 PTR, BYVAL AS const guint8 PTR, BYVAL AS guint) AS guint8 PTR
DECLARE FUNCTION g_byte_array_ref(BYVAL AS guint8 PTR) AS guint8 PTR
DECLARE FUNCTION g_byte_array_remove_index(BYVAL AS guint8 PTR, BYVAL AS guint) AS guint8 PTR
DECLARE FUNCTION g_byte_array_remove_index_fast(BYVAL AS guint8 PTR, BYVAL AS guint) AS guint8 PTR
DECLARE FUNCTION g_byte_array_remove_range(BYVAL AS guint8 PTR, BYVAL AS guint, BYVAL AS guint) AS guint8 PTR
DECLARE FUNCTION g_byte_array_set_size(BYVAL AS guint8 PTR, BYVAL AS guint) AS guint8 PTR
DECLARE FUNCTION g_byte_array_sized_new(BYVAL AS guint) AS guint8 PTR
DECLARE SUB g_byte_array_sort(BYVAL AS guint8 PTR, BYVAL AS GCompareFunc)
DECLARE SUB g_byte_array_sort_with_data(BYVAL AS guint8 PTR, BYVAL AS GCompareDataFunc, BYVAL AS gpointer)
DECLARE SUB g_byte_array_unref(BYVAL AS guint8 PTR)
...
DECLARE FUNCTION g_bytes_unref_to_array(BYVAL AS GBytes PTR) AS gconstpointer
...
DECLARE SUB g_checksum_update(BYVAL AS GChecksum PTR, BYVAL AS guchar PTR, BYVAL AS gssize)
...
DECLARE FUNCTION g_dir_read_name(BYVAL AS GDir PTR) AS gchar PTR
DECLARE SUB g_dir_rewind(BYVAL AS GDir PTR)
DECLARE FUNCTION g_dir_make_tmp(BYVAL AS gchar PTR, BYVAL AS GError PTR PTR) AS gchar PTR
...
DECLARE SUB g_hmac_update(BYVAL AS GHmac PTR, BYVAL AS guchar PTR, BYVAL AS gssize)
DECLARE FUNCTION g_hmac_new(BYVAL AS GChecksumType, BYVAL AS guchar PTR, BYVAL AS gsize) AS GHmac PTR
TYPE _GHook
  AS gpointer data
  AS GHook PTR next
  AS GHook PTR prev
...
END TYPE
DECLARE FUNCTION g_io_channel_new_file(BYVAL AS gchar PTR, BYVAL AS const gchar PTR, BYVAL AS GError PTR PTR) AS GIOChannel PTR
...
DECLARE FUNCTION g_io_channel_write_chars(BYVAL AS GIOChannel PTR, BYVAL AS gchar PTR, BYVAL AS gssize, BYVAL AS gsize PTR, BYVAL AS GError PTR PTR) AS GIOStatus
...
DECLARE FUNCTION g_key_file_load_from_data_dirs(BYVAL AS GKeyFile PTR, BYVAL AS gchar PTR, BYVAL AS gchar PTR PTR, BYVAL AS GKeyFileFlags, BYVAL AS GError PTR PTR) AS gboolean
DECLARE FUNCTION g_key_file_load_from_dirs(BYVAL AS GKeyFile PTR, BYVAL AS gchar PTR, BYVAL AS gchar PTR PTR, BYVAL AS gchar PTR PTR, BYVAL AS GKeyFileFlags, BYVAL AS GError PTR PTR) AS gboolean
DECLARE FUNCTION g_key_file_load_from_file(BYVAL AS GKeyFile PTR, BYVAL AS gchar PTR, BYVAL AS GKeyFileFlags, BYVAL AS GError PTR PTR) AS gboolean
...
DECLARE SUB g_key_file_set_boolean_list(BYVAL AS GKeyFile PTR, BYVAL AS const gchar PTR, BYVAL AS const gchar PTR, BYVAL AS gboolean, BYVAL AS gsize)
...
DECLARE SUB g_key_file_set_double_list(BYVAL AS GKeyFile PTR, BYVAL AS const gchar PTR, BYVAL AS const gchar PTR, BYVAL AS gdouble, BYVAL AS gsize)
...
DECLARE SUB g_key_file_set_integer_list(BYVAL AS GKeyFile PTR, BYVAL AS const gchar PTR, BYVAL AS const gchar PTR, BYVAL AS gint, BYVAL AS gsize)
...
DECLARE SUB g_key_file_set_locale_string_list(BYVAL AS GKeyFile PTR, BYVAL AS const gchar PTR, BYVAL AS const gchar PTR, BYVAL AS const gchar PTR, BYVAL AS gchar PTR, BYVAL AS gsize)
...
DECLARE SUB g_key_file_set_string_list(BYVAL AS GKeyFile PTR, BYVAL AS const gchar PTR, BYVAL AS const gchar PTR, BYVAL AS gchar PTR, BYVAL AS gsize)
...
TYPE GLogWriterFunc AS FUNCTION CDECL(BYVAL AS GLogLevelFlags, BYVAL AS GLogField PTR, BYVAL AS gsize, BYVAL AS gpointer) AS GLogWriterOutput
...
DECLARE FUNCTION g_mapped_file_new(BYVAL AS gchar PTR, BYVAL AS gboolean, BYVAL AS GError PTR PTR) AS GMappedFile PTR
...
TYPE _GPtrArray
  ...
  AS guint len
END TYPE
DECLARE SUB g_ptr_array_add(BYVAL AS gpointer, BYVAL AS gpointer)
DECLARE SUB g_ptr_array_foreach(BYVAL AS gpointer, BYVAL AS GFunc, BYVAL AS gpointer)
DECLARE FUNCTION g_ptr_array_free(BYVAL AS gpointer, BYVAL AS gboolean) AS gpointer PTR
DECLARE SUB g_ptr_array_insert(BYVAL AS gpointer, BYVAL AS gint, BYVAL AS gpointer)
DECLARE FUNCTION g_ptr_array_new() AS gpointer
DECLARE FUNCTION g_ptr_array_new_full(BYVAL AS guint, BYVAL AS GDestroyNotify) AS gpointer
DECLARE FUNCTION g_ptr_array_new_with_free_func(BYVAL AS GDestroyNotify) AS gpointer
DECLARE FUNCTION g_ptr_array_ref(BYVAL AS gpointer) AS gpointer
DECLARE FUNCTION g_ptr_array_remove(BYVAL AS gpointer, BYVAL AS gpointer) AS gboolean
DECLARE FUNCTION g_ptr_array_remove_fast(BYVAL AS gpointer, BYVAL AS gpointer) AS gboolean
DECLARE FUNCTION g_ptr_array_remove_index(BYVAL AS gpointer, BYVAL AS guint) AS gpointer
DECLARE FUNCTION g_ptr_array_remove_index_fast(BYVAL AS gpointer, BYVAL AS guint) AS gpointer
DECLARE FUNCTION g_ptr_array_remove_range(BYVAL AS gpointer, BYVAL AS guint, BYVAL AS guint) AS gpointer
DECLARE SUB g_ptr_array_set_free_func(BYVAL AS gpointer, BYVAL AS GDestroyNotify)
DECLARE SUB g_ptr_array_set_size(BYVAL AS gpointer, BYVAL AS gint)
DECLARE FUNCTION g_ptr_array_sized_new(BYVAL AS guint) AS gpointer
DECLARE SUB g_ptr_array_sort(BYVAL AS gpointer, BYVAL AS GCompareFunc)
DECLARE SUB g_ptr_array_sort_with_data(BYVAL AS gpointer, BYVAL AS GCompareDataFunc, BYVAL AS gpointer)
DECLARE SUB g_ptr_array_unref(BYVAL AS gpointer)
TYPE _GQueue
  AS GList PTR head
  AS GList PTR tail
  AS guint length
...
DECLARE FUNCTION g_regex_match_all_full(BYVAL AS const GRegex PTR, BYVAL AS gchar PTR, BYVAL AS gssize, BYVAL AS gint, BYVAL AS GRegexMatchFlags, BYVAL AS GMatchInfo PTR PTR, BYVAL AS GError PTR PTR) AS gboolean
DECLARE FUNCTION g_regex_match_full(BYVAL AS const GRegex PTR, BYVAL AS gchar PTR, BYVAL AS gssize, BYVAL AS gint, BYVAL AS GRegexMatchFlags, BYVAL AS GMatchInfo PTR PTR, BYVAL AS GError PTR PTR) AS gboolean
DECLARE FUNCTION g_regex_ref(BYVAL AS GRegex PTR) AS GRegex PTR
DECLARE FUNCTION g_regex_replace(BYVAL AS const GRegex PTR, BYVAL AS gchar PTR, BYVAL AS gssize, BYVAL AS gint, BYVAL AS const gchar PTR, BYVAL AS GRegexMatchFlags, BYVAL AS GError PTR PTR) AS gchar PTR
DECLARE FUNCTION g_regex_replace_eval(BYVAL AS const GRegex PTR, BYVAL AS gchar PTR, BYVAL AS gssize, BYVAL AS gint, BYVAL AS GRegexMatchFlags, BYVAL AS GRegexEvalCallback, BYVAL AS gpointer, BYVAL AS GError PTR PTR) AS gchar PTR
DECLARE FUNCTION g_regex_replace_literal(BYVAL AS const GRegex PTR, BYVAL AS gchar PTR, BYVAL AS gssize, BYVAL AS gint, BYVAL AS const gchar PTR, BYVAL AS GRegexMatchFlags, BYVAL AS GError PTR PTR) AS gchar PTR
...
DECLARE FUNCTION g_regex_split_full(BYVAL AS const GRegex PTR, BYVAL AS gchar PTR, BYVAL AS gssize, BYVAL AS gint, BYVAL AS GRegexMatchFlags, BYVAL AS gint, BYVAL AS GError PTR PTR) AS gchar PTR PTR
...
DECLARE FUNCTION g_regex_escape_string(BYVAL AS gchar PTR, BYVAL AS gint) AS gchar PTR
...
DECLARE FUNCTION g_variant_new_array(BYVAL AS const GVariantType PTR, BYVAL AS GVariant PTR PTR, BYVAL AS gsize) AS GVariant PTR
...
DECLARE FUNCTION g_variant_new_bytestring(BYVAL AS gchar PTR) AS GVariant PTR
DECLARE FUNCTION g_variant_new_bytestring_array(BYVAL AS gchar PTR PTR, BYVAL AS gssize) AS GVariant PTR
...
DECLARE FUNCTION g_variant_new_objv(BYVAL AS gchar PTR PTR, BYVAL AS gssize) AS GVariant PTR
...
DECLARE FUNCTION g_variant_new_strv(BYVAL AS gchar PTR PTR, BYVAL AS gssize) AS GVariant PTR
DECLARE FUNCTION g_variant_new_take_string(BYVAL AS gchar PTR) AS GVariant PTR
DECLARE FUNCTION g_variant_new_tuple(BYVAL AS GVariant PTR PTR, BYVAL AS gsize) AS GVariant PTR
...
DECLARE FUNCTION g_variant_get_bytestring(BYVAL AS GVariant PTR) AS gchar PTR
DECLARE FUNCTION g_variant_get_bytestring_array(BYVAL AS GVariant PTR, BYVAL AS gsize PTR) AS gchar PTR PTR
...
DECLARE FUNCTION g_variant_get_objv(BYVAL AS GVariant PTR, BYVAL AS gsize PTR) AS gchar PTR PTR
...
DECLARE FUNCTION g_variant_get_strv(BYVAL AS GVariant PTR, BYVAL AS gsize PTR) AS gchar PTR PTR
...
DECLARE FUNCTION g_variant_type_new_tuple(BYVAL AS GVariantType PTR PTR, BYVAL AS gint) AS GVariantType PTR
...
DECLARE FUNCTION g_access(BYVAL AS gchar PTR, BYVAL AS gint /'int'/) AS gint /'int'/
...
DECLARE FUNCTION g_base64_decode_step(BYVAL AS gchar PTR, BYVAL AS gsize, BYVAL AS guchar PTR, BYVAL AS gint PTR, BYVAL AS guint PTR) AS gsize
DECLARE FUNCTION g_base64_encode(BYVAL AS guchar PTR, BYVAL AS gsize) AS gchar PTR
DECLARE FUNCTION g_base64_encode_close(BYVAL AS gboolean, BYVAL AS gchar PTR, BYVAL AS gint PTR, BYVAL AS gint PTR) AS gsize
DECLARE FUNCTION g_base64_encode_step(BYVAL AS guchar PTR, BYVAL AS gsize, BYVAL AS gboolean, BYVAL AS gchar PTR, BYVAL AS gint PTR, BYVAL AS gint PTR) AS gsize
DECLARE FUNCTION g_basename(BYVAL AS gchar PTR) AS gchar PTR
...
DECLARE FUNCTION g_build_filename(BYVAL AS gchar PTR, ...) AS gchar PTR
DECLARE FUNCTION g_build_filenamev(BYVAL AS gchar PTR PTR) AS gchar PTR
DECLARE FUNCTION g_build_path(BYVAL AS gchar PTR, BYVAL AS gchar PTR, ...) AS gchar PTR
DECLARE FUNCTION g_build_pathv(BYVAL AS const gchar PTR, BYVAL AS gchar PTR PTR) AS gchar PTR
DECLARE FUNCTION g_chdir(BYVAL AS gchar PTR) AS gint /'int'/
...
DECLARE FUNCTION g_compute_checksum_for_data(BYVAL AS GChecksumType, BYVAL AS guchar PTR, BYVAL AS gsize) AS gchar PTR
...
DECLARE FUNCTION g_compute_hmac_for_data(BYVAL AS GChecksumType, BYVAL AS guchar PTR, BYVAL AS gsize, BYVAL AS guchar PTR, BYVAL AS gsize) AS gchar PTR
DECLARE FUNCTION g_compute_hmac_for_string(BYVAL AS GChecksumType, BYVAL AS guchar PTR, BYVAL AS gsize, BYVAL AS const gchar PTR, BYVAL AS gssize) AS gchar PTR
...
DECLARE FUNCTION g_file_get_contents(BYVAL AS gchar PTR, BYVAL AS gchar PTR PTR, BYVAL AS gsize PTR, BYVAL AS GError PTR PTR) AS gboolean
DECLARE FUNCTION g_file_open_tmp(BYVAL AS gchar PTR, BYVAL AS gchar PTR PTR, BYVAL AS GError PTR PTR) AS gint
DECLARE FUNCTION g_file_read_link(BYVAL AS gchar PTR, BYVAL AS GError PTR PTR) AS gchar PTR
DECLARE FUNCTION g_file_set_contents(BYVAL AS gchar PTR, BYVAL AS gchar PTR, BYVAL AS gssize, BYVAL AS GError PTR PTR) AS gboolean
DECLARE FUNCTION g_file_test(BYVAL AS gchar PTR, BYVAL AS GFileTest) AS gboolean
DECLARE FUNCTION g_filename_display_basename(BYVAL AS gchar PTR) AS gchar PTR
DECLARE FUNCTION g_filename_display_name(BYVAL AS gchar PTR) AS gchar PTR
...
DECLARE FUNCTION g_filename_to_uri(BYVAL AS gchar PTR, BYVAL AS const gchar PTR, BYVAL AS GError PTR PTR) AS gchar PTR
DECLARE FUNCTION g_filename_to_utf8(BYVAL AS gchar PTR, BYVAL AS gssize, BYVAL AS gsize PTR, BYVAL AS gsize PTR, BYVAL AS GError PTR PTR) AS gchar PTR
DECLARE FUNCTION g_find_program_in_path(BYVAL AS gchar PTR) AS gchar PTR
...
DECLARE FUNCTION g_fprintf(BYVAL AS FILE PTR, BYVAL AS gchar PTR, ...) AS gint
...
DECLARE FUNCTION g_get_home_dir() AS gchar PTR
DECLARE FUNCTION g_get_host_name() AS const gchar PTR
DECLARE FUNCTION g_get_language_names() AS gchar PTR PTR
...
DECLARE FUNCTION g_get_real_name() AS gchar PTR
DECLARE FUNCTION g_get_real_time() AS gint64
DECLARE FUNCTION g_get_system_config_dirs() AS gchar PTR PTR
DECLARE FUNCTION g_get_system_data_dirs() AS gchar PTR PTR
DECLARE FUNCTION g_get_tmp_dir() AS gchar PTR
DECLARE FUNCTION g_get_user_cache_dir() AS gchar PTR
DECLARE FUNCTION g_get_user_config_dir() AS gchar PTR
DECLARE FUNCTION g_get_user_data_dir() AS gchar PTR
DECLARE FUNCTION g_get_user_name() AS gchar PTR
DECLARE FUNCTION g_get_user_runtime_dir() AS gchar PTR
DECLARE FUNCTION g_get_user_special_dir(BYVAL AS GUserDirectory) AS gchar PTR
...
DECLARE SUB g_log_structured_array(BYVAL AS GLogLevelFlags, BYVAL AS GLogField PTR, BYVAL AS gsize)
DECLARE SUB g_log_variant(BYVAL AS const gchar PTR, BYVAL AS GLogLevelFlags, BYVAL AS GVariant PTR)
DECLARE FUNCTION g_log_writer_default(BYVAL AS GLogLevelFlags, BYVAL AS GLogField PTR, BYVAL AS gsize, BYVAL AS gpointer) AS GLogWriterOutput
DECLARE FUNCTION g_log_writer_format_fields(BYVAL AS GLogLevelFlags, BYVAL AS GLogField PTR, BYVAL AS gsize, BYVAL AS gboolean) AS gchar PTR
DECLARE FUNCTION g_log_writer_is_journald(BYVAL AS gint) AS gboolean
DECLARE FUNCTION g_log_writer_journald(BYVAL AS GLogLevelFlags, BYVAL AS GLogField PTR, BYVAL AS gsize, BYVAL AS gpointer) AS GLogWriterOutput
DECLARE FUNCTION g_log_writer_standard_streams(BYVAL AS GLogLevelFlags, BYVAL AS GLogField PTR, BYVAL AS gsize, BYVAL AS gpointer) AS GLogWriterOutput
...
DECLARE FUNCTION g_mkdir_with_parents(BYVAL AS gchar PTR, BYVAL AS gint) AS gint
...
DECLARE FUNCTION g_parse_debug_string(BYVAL AS const gchar PTR, BYVAL AS GDebugKey PTR, BYVAL AS guint) AS guint
DECLARE FUNCTION g_path_get_basename(BYVAL AS gchar PTR) AS gchar PTR
DECLARE FUNCTION g_path_get_dirname(BYVAL AS gchar PTR) AS gchar PTR
DECLARE FUNCTION g_path_is_absolute(BYVAL AS gchar PTR) AS gboolean
DECLARE FUNCTION g_path_skip_root(BYVAL AS gchar PTR) AS gchar PTR
...
DECLARE FUNCTION g_printf(BYVAL AS gchar PTR, ...) AS gint
...
DECLARE FUNCTION g_rmdir(BYVAL AS gchar PTR) AS gint /'int'/
...
DECLARE FUNCTION g_snprintf(BYVAL AS gchar PTR, BYVAL AS gulong, BYVAL AS gchar PTR, ...) AS gint
DECLARE FUNCTION g_spaced_primes_closest(BYVAL AS guint) AS guint
DECLARE FUNCTION g_spawn_async(BYVAL AS gchar PTR, BYVAL AS gchar PTR PTR, BYVAL AS gchar PTR PTR, BYVAL AS GSpawnFlags, BYVAL AS GSpawnChildSetupFunc, BYVAL AS gpointer, BYVAL AS GPid PTR, BYVAL AS GError PTR PTR) AS gboolean
DECLARE FUNCTION g_spawn_async_with_pipes(BYVAL AS gchar PTR, BYVAL AS gchar PTR PTR, BYVAL AS gchar PTR PTR, BYVAL AS GSpawnFlags, BYVAL AS GSpawnChildSetupFunc, BYVAL AS gpointer, BYVAL AS GPid PTR, BYVAL AS gint PTR, BYVAL AS gint PTR, BYVAL AS gint PTR, BYVAL AS GError PTR PTR) AS gboolean
...
DECLARE FUNCTION g_spawn_sync(BYVAL AS gchar PTR, BYVAL AS gchar PTR PTR, BYVAL AS gchar PTR PTR, BYVAL AS GSpawnFlags, BYVAL AS GSpawnChildSetupFunc, BYVAL AS gpointer, BYVAL AS gchar PTR PTR, BYVAL AS gchar PTR PTR, BYVAL AS gint PTR, BYVAL AS GError PTR PTR) AS gboolean
DECLARE FUNCTION g_sprintf(BYVAL AS gchar PTR, BYVAL AS gchar PTR, ...) AS gint
...
DECLARE FUNCTION g_test_get_dir(BYVAL AS GTestFileType) AS gchar PTR
...
DECLARE FUNCTION g_unlink(BYVAL AS gchar PTR) AS gint /'int'/
...
DECLARE FUNCTION g_utf8_validate(BYVAL AS gchar PTR, BYVAL AS gssize, BYVAL AS const gchar PTR PTR) AS gboolean
DECLARE FUNCTION g_variant_get_gtype() AS GType
DECLARE FUNCTION g_vasprintf(BYVAL AS gchar PTR PTR, BYVAL AS gchar PTR, BYVAL AS va_list) AS gint
DECLARE FUNCTION g_vfprintf(BYVAL AS FILE PTR, BYVAL AS gchar PTR, BYVAL AS va_list) AS gint
DECLARE FUNCTION g_vprintf(BYVAL AS gchar PTR, BYVAL AS va_list) AS gint
DECLARE FUNCTION g_vsnprintf(BYVAL AS gchar PTR, BYVAL AS gulong, BYVAL AS gchar PTR, BYVAL AS va_list) AS gint
DECLARE FUNCTION g_vsprintf(BYVAL AS gchar PTR, BYVAL AS gchar PTR, BYVAL AS va_list) AS gint
