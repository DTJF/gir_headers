...
' Auto-translated from file ../gir-1.0/HarfBuzz-0.0.gir
...
DECLARE FUNCTION hb_buffer_serialize_format_from_string(BYVAL AS char PTR, BYVAL AS gint /'int'/) AS hb_buffer_serialize_format_t
...
DECLARE SUB hb_buffer_set_segment_properties(BYVAL AS hb_buffer_t PTR, BYVAL AS hb_segment_properties_t const /'const hb_segment_properties_t'/ PTR)
...
DECLARE SUB hb_ot_shape_glyphs_closure(BYVAL AS hb_font_t PTR, BYVAL AS hb_buffer_t PTR, BYVAL AS hb_feature_t const /'const hb_feature_t'/ PTR, BYVAL AS guint /'unsigned int'/, BYVAL AS hb_set_t PTR)
...
DECLARE FUNCTION hb_segment_properties_equal(BYVAL AS hb_segment_properties_t const /'const hb_segment_properties_t'/ PTR, BYVAL AS hb_segment_properties_t const /'const hb_segment_properties_t'/ PTR) AS hb_bool_t
DECLARE FUNCTION hb_segment_properties_hash(BYVAL AS hb_segment_properties_t const /'const hb_segment_properties_t'/ PTR) AS guint /'unsigned int'/
...
DECLARE FUNCTION hb_shape_plan_create(BYVAL AS hb_face_t PTR, BYVAL AS hb_segment_properties_t const /'const hb_segment_properties_t'/ PTR, BYVAL AS hb_feature_t PTR, BYVAL AS guint /'unsigned int'/, BYVAL AS char PTR PTR) AS hb_shape_plan_t PTR
DECLARE FUNCTION hb_shape_plan_create2(BYVAL AS hb_face_t PTR, BYVAL AS hb_segment_properties_t const /'const hb_segment_properties_t'/ PTR, BYVAL AS hb_feature_t const /'const hb_feature_t'/ PTR, BYVAL AS guint /'unsigned int'/, BYVAL AS const gint /'const int'/ PTR, BYVAL AS guint /'unsigned int'/, BYVAL AS const gchar const PTR) AS hb_shape_plan_t PTR
DECLARE FUNCTION hb_shape_plan_create_cached(BYVAL AS hb_face_t PTR, BYVAL AS hb_segment_properties_t const /'const hb_segment_properties_t'/ PTR, BYVAL AS hb_feature_t PTR, BYVAL AS guint /'unsigned int'/, BYVAL AS char PTR PTR) AS hb_shape_plan_t PTR
DECLARE FUNCTION hb_shape_plan_create_cached2(BYVAL AS hb_face_t PTR, BYVAL AS hb_segment_properties_t const /'const hb_segment_properties_t'/ PTR, BYVAL AS hb_feature_t const /'const hb_feature_t'/ PTR, BYVAL AS guint /'unsigned int'/, BYVAL AS const gint /'const int'/ PTR, BYVAL AS guint /'unsigned int'/, BYVAL AS const gchar const PTR) AS hb_shape_plan_t PTR
