...
' Auto-translated from file ../../gir_headers/input/GooCanvas-2.0.gir
...
DECLARE FUNCTION goo_canvas_create_pattern_from_gdk_rgba_value(BYVAL AS const GValue PTR) AS cairo_pattern_t PTR
...
DECLARE SUB goo_canvas_get_gdk_rgba_value_from_pattern(BYVAL AS cairo_pattern_t PTR, BYVAL AS GValue PTR)
