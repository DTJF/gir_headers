...
' Auto-translated from file ../gir-1.0/Gdk-3.0.gir
...
DECLARE FUNCTION gdk_seat_grab(BYVAL AS GdkSeat PTR, BYVAL AS GdkWindow PTR, BYVAL AS GdkSeatCapabilities, BYVAL AS gboolean, BYVAL AS GdkCursor PTR, BYVAL AS const any ptr /'const GdkEvent'/ PTR, BYVAL AS GdkSeatGrabPrepareFunc, BYVAL AS gpointer) AS GdkGrabStatus
