...
' Auto-translated from file ../gir-1.0/Atk-1.0.gir
...
DECLARE FUNCTION atk_relation_get_target(BYVAL AS AtkRelation PTR) AS AtkObject PTR PTR
...
TYPE _AtkSocketClass
  AS AtkObjectClass parent_class
  embed AS SUB CDECL(BYVAL AS AtkSocket PTR, BYVAL AS gchar PTR)
END TYPE
TYPE _AtkStateSet
  AS GObject parent
END TYPE
...
DECLARE FUNCTION atk_table_cell_get_column_header_cells(BYVAL AS AtkTableCell PTR) AS AtkStateType PTR
...
DECLARE FUNCTION atk_table_cell_get_row_header_cells(BYVAL AS AtkTableCell PTR) AS AtkStateType PTR
...
TYPE _AtkTableCellIface
  ...
  get_column_header_cells AS FUNCTION CDECL(BYVAL AS AtkTableCell PTR) AS AtkStateType PTR
  ...
  get_row_header_cells AS FUNCTION CDECL(BYVAL AS AtkTableCell PTR) AS AtkStateType PTR
