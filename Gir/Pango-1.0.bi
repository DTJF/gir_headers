...
' Auto-translated from file ../gir-1.0/Pango-1.0.gir
...
END ENUM
TYPE AS _PangoScriptForLang PangoScriptForLang
...
TYPE _PangoFontClass
  ...
  find_shaper AS FUNCTION CDECL(BYVAL AS PangoFont PTR, BYVAL AS PangoLanguage PTR, BYVAL AS guint32) AS PangoEngineShape PTR
...
DECLARE FUNCTION pango_font_map_get_shape_engine_type(BYVAL AS PangoFontMap PTR) AS const char PTR
...
DECLARE FUNCTION pango_language_get_scripts(BYVAL AS PangoLanguage PTR, BYVAL AS gint /'int'/ PTR) AS PangoScript PTR
...
DECLARE FUNCTION pango_layout_get_log_attrs_readonly(BYVAL AS PangoLayout PTR, BYVAL AS gint PTR) AS PangoLogAttr PTR
...
DECLARE FUNCTION pango_config_key_get(BYVAL AS const char PTR) AS char PTR
DECLARE FUNCTION pango_config_key_get_system(BYVAL AS const char PTR) AS char PTR
...
DECLARE FUNCTION pango_get_lib_subdirectory() AS const char PTR
...
DECLARE FUNCTION pango_get_sysconf_subdirectory() AS const char PTR
...
DECLARE SUB pango_lookup_aliases(BYVAL AS const char PTR, BYVAL AS char PTR PTR PTR, BYVAL AS gint /'int'/ PTR)
...
DECLARE SUB pango_shape_full(BYVAL AS const gchar PTR, BYVAL AS gint, BYVAL AS const gchar PTR, BYVAL AS gint, BYVAL AS const PangoAnalysis PTR, BYVAL AS PangoGlyphString PTR)
