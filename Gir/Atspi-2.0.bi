...
' Auto-translated from file ../gir-1.0/Atspi-2.0.gir
...
TYPE AS gpointer AtspiKeystrokeListener
...
#DEFINE ATSPI_COORD_TYPE_COUNT 2
...
TYPE AS LONG AtspiError
ENUM
  ATSPI_ERROR_APPLICATION_GONE = 0
  ATSPI_ERROR_IPC = 1
  ATSPI_ERROR_SYNC_NOT_ALLOWED = 2
END ENUM
...
#DEFINE ATSPI_RELATIONTYPE_COUNT 20
#DEFINE ATSPI_ROLE_COUNT 122
TYPE AS _AtspiRange AtspiRange
TYPE AS _AtspiRect AtspiRect
TYPE AS _AtspiReference AtspiReference
...
ENUM
  ...
  ATSPI_RELATION_LAST_DEFINED = 19
END ENUM
...
END TYPE
TYPE _AtspiAccessiblePrivate
  AS GHashTable PTR cache
  AS guint cache_ref_count
END TYPE
...
DECLARE FUNCTION atspi_state_set_new(BYVAL AS gint) AS AtspiStateSet PTR
...
DECLARE FUNCTION atspi_state_set_get_states(BYVAL AS AtspiStateSet PTR) AS gint
...
DECLARE FUNCTION atspi_table_get_selected_columns(BYVAL AS AtspiTable PTR, BYVAL AS GError PTR PTR) AS gint
DECLARE FUNCTION atspi_table_get_selected_rows(BYVAL AS AtspiTable PTR, BYVAL AS GError PTR PTR) AS gint
...
DECLARE FUNCTION atspi_table_cell_get_column_header_cells(BYVAL AS AtspiTableCell PTR, BYVAL AS GError PTR PTR) AS gint
...
DECLARE FUNCTION atspi_table_cell_get_row_header_cells(BYVAL AS AtspiTableCell PTR, BYVAL AS GError PTR PTR) AS gint
DECLARE FUNCTION atspi_table_cell_get_row_index(BYVAL AS AtspiTableCell PTR, BYVAL AS GError PTR PTR) AS gint
...
DECLARE FUNCTION atspi_text_get_bounded_ranges(BYVAL AS AtspiText PTR, BYVAL AS gint, BYVAL AS gint, BYVAL AS gint, BYVAL AS gint, BYVAL AS AtspiCoordType, BYVAL AS AtspiTextClipType, BYVAL AS AtspiTextClipType, BYVAL AS GError PTR PTR) AS gint
...
DECLARE FUNCTION atspi_deregister_keystroke_listener(BYVAL AS AtspiDeviceListener PTR, BYVAL AS gint, BYVAL AS AtspiKeyMaskType, BYVAL AS AtspiKeyEventMask, BYVAL AS GError PTR PTR) AS gboolean
...
DECLARE FUNCTION atspi_get_desktop_list() AS gint
...
DECLARE FUNCTION atspi_register_keystroke_listener(BYVAL AS AtspiDeviceListener PTR, BYVAL AS gint, BYVAL AS AtspiKeyMaskType, BYVAL AS AtspiKeyEventMask, BYVAL AS AtspiKeyListenerSyncType, BYVAL AS GError PTR PTR) AS gboolean
