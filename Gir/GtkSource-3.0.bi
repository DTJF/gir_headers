...
' Auto-translated from file ../gir-1.0/GtkSource-3.0.gir
...
DECLARE FUNCTION gtk_source_language_manager_get_language_ids(BYVAL AS GtkSourceLanguageManager PTR) AS gchar PTR PTR
DECLARE FUNCTION gtk_source_language_manager_get_search_path(BYVAL AS GtkSourceLanguageManager PTR) AS gchar PTR PTR
...
DECLARE FUNCTION gtk_source_style_scheme_get_authors(BYVAL AS GtkSourceStyleScheme PTR) AS gchar PTR PTR
...
DECLARE FUNCTION gtk_source_style_scheme_manager_get_scheme_ids(BYVAL AS GtkSourceStyleSchemeManager PTR) AS gchar PTR PTR
DECLARE FUNCTION gtk_source_style_scheme_manager_get_search_path(BYVAL AS GtkSourceStyleSchemeManager PTR) AS gchar PTR PTR
