...
TYPE AS gpointer GInitiallyUnowned_autoptr
TYPE AS gpointer GObject_autoptr
...
DECLARE SUB g_closure_invoke(BYVAL AS GClosure PTR, BYVAL AS GValue PTR, BYVAL AS guint, BYVAL AS GValue PTR, BYVAL AS gpointer)
...
DECLARE SUB g_signal_chain_from_overridden(BYVAL AS GValue PTR, BYVAL AS GValue PTR)
...
DECLARE SUB g_signal_emitv(BYVAL AS GValue PTR, BYVAL AS guint, BYVAL AS GQuark, BYVAL AS GValue PTR)
