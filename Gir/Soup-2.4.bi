...
' Auto-translated from file ../../gir_headers/input/Soup-2.4.gir
...
DECLARE SUB soup_buffer_get_data(BYVAL AS SoupBuffer PTR, BYVAL AS guint8 PTR PTR, BYVAL AS gsize PTR)
...
DECLARE SUB soup_message_set_request(BYVAL AS SoupMessage PTR, BYVAL AS const char PTR, BYVAL AS SoupMemoryUse, BYVAL AS char PTR, BYVAL AS gsize)
DECLARE SUB soup_message_set_response(BYVAL AS SoupMessage PTR, BYVAL AS const char PTR, BYVAL AS SoupMemoryUse, BYVAL AS char PTR, BYVAL AS gsize)
