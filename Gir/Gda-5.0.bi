...
' Auto-translated from file ../../gir_headers/input/Gda-5.0.gir
...
DECLARE FUNCTION gda_data_access_wrapper_set_mapping(BYVAL AS GdaDataAccessWrapper PTR, BYVAL AS gint PTR, BYVAL AS gint) AS gboolean
...
DECLARE SUB gda_data_comparator_set_key_columns(BYVAL AS GdaDataComparator PTR, BYVAL AS gint PTR, BYVAL AS gint)
...
DECLARE FUNCTION gda_data_model_export_to_file(BYVAL AS GdaDataModel PTR, BYVAL AS GdaDataModelIOFormat, BYVAL AS const gchar PTR, BYVAL AS gint PTR, BYVAL AS gint, BYVAL AS gint PTR, BYVAL AS gint, BYVAL AS GdaSet PTR, BYVAL AS GError PTR PTR) AS gboolean
DECLARE FUNCTION gda_data_model_export_to_string(BYVAL AS GdaDataModel PTR, BYVAL AS GdaDataModelIOFormat, BYVAL AS gint PTR, BYVAL AS gint, BYVAL AS gint PTR, BYVAL AS gint, BYVAL AS GdaSet PTR) AS gchar PTR
...
DECLARE FUNCTION gda_meta_store_modify_v(BYVAL AS GdaMetaStore PTR, BYVAL AS const gchar PTR, BYVAL AS GdaDataModel PTR, BYVAL AS const gchar PTR, BYVAL AS gint, BYVAL AS gchar PTR PTR, BYVAL AS GValue PTR PTR, BYVAL AS GError PTR PTR) AS gboolean
...
DECLARE FUNCTION gda_sql_builder_add_case_v(BYVAL AS GdaSqlBuilder PTR, BYVAL AS GdaSqlBuilderId, BYVAL AS GdaSqlBuilderId, BYVAL AS GdaSqlBuilderId PTR, BYVAL AS GdaSqlBuilderId PTR, BYVAL AS gint) AS GdaSqlBuilderId
...
DECLARE FUNCTION gda_sql_builder_add_cond_v(BYVAL AS GdaSqlBuilder PTR, BYVAL AS GdaSqlOperatorType, BYVAL AS GdaSqlBuilderId PTR, BYVAL AS gint) AS GdaSqlBuilderId
...
DECLARE FUNCTION gda_sql_builder_add_function_v(BYVAL AS GdaSqlBuilder PTR, BYVAL AS const gchar PTR, BYVAL AS GdaSqlBuilderId PTR, BYVAL AS gint) AS GdaSqlBuilderId
...
DECLARE FUNCTION gda_utility_data_model_dump_data_to_xml(BYVAL AS GdaDataModel PTR, BYVAL AS any ptr /' xmlNodePtr '/, BYVAL AS gint PTR, BYVAL AS gint, BYVAL AS gint PTR, BYVAL AS gint, BYVAL AS gboolean) AS gboolean
