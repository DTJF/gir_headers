...
TYPE AS gpointer GdkPixbufAnimationIter_autoptr
TYPE AS gpointer GdkPixbufAnimation_autoptr
TYPE AS gpointer GdkPixbufLoader_autoptr
TYPE AS gpointer GdkPixbufSimpleAnim_autoptr
TYPE AS gpointer GdkPixbuf_autoptr
...
#DEFINE GDK_PIXBUF_VERSION @!"2.32.2"
...
DECLARE FUNCTION gdk_pixbuf_new_from_data(BYVAL AS guchar PTR, BYVAL AS GdkColorspace, BYVAL AS gboolean, BYVAL AS gint /'int'/, BYVAL AS gint /'int'/, BYVAL AS gint /'int'/, BYVAL AS gint /'int'/, BYVAL AS GdkPixbufDestroyNotify, BYVAL AS gpointer) AS GdkPixbuf PTR
...
DECLARE FUNCTION gdk_pixbuf_new_from_inline(BYVAL AS gint, BYVAL AS guint8 PTR, BYVAL AS gboolean, BYVAL AS GError PTR PTR) AS GdkPixbuf PTR
...
DECLARE FUNCTION gdk_pixbuf_new_from_xpm_data(BYVAL AS char PTR PTR) AS GdkPixbuf PTR
...
DECLARE FUNCTION gdk_pixbuf_loader_write(BYVAL AS GdkPixbufLoader PTR, BYVAL AS guchar PTR, BYVAL AS gsize, BYVAL AS GError PTR PTR) AS gboolean
...
END TYPE
DECLARE FUNCTION gdk_pixdata_deserialize(BYVAL AS GdkPixdata PTR, BYVAL AS guint, BYVAL AS guint8 PTR, BYVAL AS GError PTR PTR) AS gboolean
