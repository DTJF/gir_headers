...
TYPE _GtkContainerClass
  ...
  AS guint /'unsigned'/ _handle_border_width : 1
...
DECLARE SUB gtk_action_group_add_actions(BYVAL AS GtkActionGroup PTR, BYVAL AS GtkActionEntry PTR, BYVAL AS guint, BYVAL AS gpointer)
DECLARE SUB gtk_action_group_add_actions_full(BYVAL AS GtkActionGroup PTR, BYVAL AS GtkActionEntry PTR, BYVAL AS guint, BYVAL AS gpointer, BYVAL AS GDestroyNotify)
DECLARE SUB gtk_action_group_add_radio_actions(BYVAL AS GtkActionGroup PTR, BYVAL AS GtkRadioActionEntry PTR, BYVAL AS guint, BYVAL AS gint, BYVAL AS GCallback, BYVAL AS gpointer)
DECLARE SUB gtk_action_group_add_radio_actions_full(BYVAL AS GtkActionGroup PTR, BYVAL AS GtkRadioActionEntry PTR, BYVAL AS guint, BYVAL AS gint, BYVAL AS GCallback, BYVAL AS gpointer, BYVAL AS GDestroyNotify)
DECLARE SUB gtk_action_group_add_toggle_actions(BYVAL AS GtkActionGroup PTR, BYVAL AS GtkToggleActionEntry PTR, BYVAL AS guint, BYVAL AS gpointer)
DECLARE SUB gtk_action_group_add_toggle_actions_full(BYVAL AS GtkActionGroup PTR, BYVAL AS GtkToggleActionEntry PTR, BYVAL AS guint, BYVAL AS gpointer, BYVAL AS GDestroyNotify)
...
DECLARE FUNCTION gtk_css_provider_load_from_data(BYVAL AS GtkCssProvider PTR, BYVAL AS gchar PTR, BYVAL AS gssize, BYVAL AS GError PTR PTR) AS gboolean
...
DECLARE FUNCTION gtk_icon_source_get_filename(BYVAL AS const GtkIconSource PTR) AS gchar PTR
...
DECLARE SUB gtk_icon_source_set_filename(BYVAL AS GtkIconSource PTR, BYVAL AS gchar PTR)
...
DECLARE FUNCTION gtk_status_icon_new_from_file(BYVAL AS gchar PTR) AS GtkStatusIcon PTR
...
DECLARE SUB gtk_status_icon_set_from_file(BYVAL AS GtkStatusIcon PTR, BYVAL AS gchar PTR)
...
DECLARE FUNCTION gtk_ui_manager_add_ui_from_file(BYVAL AS GtkUIManager PTR, BYVAL AS gchar PTR, BYVAL AS GError PTR PTR) AS guint
...
DECLARE SUB gtk_widget_path_iter_add_qclass(BYVAL AS GtkWidgetPath PTR, BYVAL AS gint, BYVAL AS GQuark)
...
DECLARE FUNCTION gtk_init_with_args(BYVAL AS gint PTR, BYVAL AS gchar PTR PTR PTR, BYVAL AS const gchar PTR, BYVAL AS GOptionEntry PTR, BYVAL AS const gchar PTR, BYVAL AS GError PTR PTR) AS gboolean
...
DECLARE SUB gtk_rc_add_default_file(BYVAL AS gchar PTR)
