...
' Auto-translated from file ../gir-1.0/Gio-2.0.gir
...
TYPE GVfsFileLookupFunc AS FUNCTION CDECL(BYVAL AS GVfs PTR, BYVAL AS const char PTR, BYVAL AS gpointer, BYVAL AS GError PTR PTR) AS GFile PTR
' P_3
...
DECLARE SUB g_app_info_launch_default_for_uri_async(BYVAL AS const char PTR, BYVAL AS GAppLaunchContext PTR, BYVAL AS GCancellable PTR, BYVAL AS GAsyncReadyCallback, BYVAL AS gpointer)
...
DECLARE FUNCTION g_app_info_get_commandline(BYVAL AS GAppInfo PTR) AS zstring /'char'/ PTR
...
DECLARE FUNCTION g_app_info_get_executable(BYVAL AS GAppInfo PTR) AS zstring /'char'/ PTR
...
DECLARE FUNCTION g_app_info_set_as_default_for_extension(BYVAL AS GAppInfo PTR, BYVAL AS zstring /'char'/ PTR, BYVAL AS GError PTR PTR) AS gboolean
...
TYPE _GAppInfoIface
  ...
  set_as_default_for_extension AS FUNCTION CDECL(BYVAL AS GAppInfo PTR, BYVAL AS zstring /'char'/ PTR, BYVAL AS GError PTR PTR) AS gboolean
...
DECLARE FUNCTION g_application_command_line_get_cwd(BYVAL AS GApplicationCommandLine PTR) AS gchar PTR
...
DECLARE FUNCTION g_desktop_app_info_new_from_filename(BYVAL AS zstring /'char'/ PTR) AS GDesktopAppInfo PTR
...
DECLARE FUNCTION g_desktop_app_info_get_filename(BYVAL AS GDesktopAppInfo PTR) AS zstring /'char'/ PTR
...
DECLARE FUNCTION g_dtls_client_connection_get_accepted_cas(BYVAL AS GDtlsClientConnection PTR) AS zstring /'char'/ PTR PTR
...
DECLARE FUNCTION g_file_new_for_commandline_arg_and_cwd(BYVAL AS const gchar PTR, BYVAL AS gchar PTR) AS GFile PTR
DECLARE FUNCTION g_file_new_for_path(BYVAL AS zstring /'char'/ PTR) AS GFile PTR
...
DECLARE FUNCTION g_file_get_child(BYVAL AS GFile PTR, BYVAL AS zstring /'char'/ PTR) AS GFile PTR
...
DECLARE FUNCTION g_file_make_symbolic_link(BYVAL AS GFile PTR, BYVAL AS zstring /'char'/ PTR, BYVAL AS GCancellable PTR, BYVAL AS GError PTR PTR) AS gboolean
...
DECLARE FUNCTION g_file_resolve_relative_path(BYVAL AS GFile PTR, BYVAL AS zstring /'char'/ PTR) AS GFile PTR
...
TYPE _GFileIface
  ...
  resolve_relative_path AS FUNCTION CDECL(BYVAL AS GFile PTR, BYVAL AS zstring /'char'/ PTR) AS GFile PTR
  ...
  make_symbolic_link AS FUNCTION CDECL(BYVAL AS GFile PTR, BYVAL AS zstring /'char'/ PTR, BYVAL AS GCancellable PTR, BYVAL AS GError PTR PTR) AS gboolean
...
DECLARE FUNCTION g_file_info_get_name(BYVAL AS GFileInfo PTR) AS zstring /'char'/ PTR
...
DECLARE SUB g_file_info_set_name(BYVAL AS GFileInfo PTR, BYVAL AS zstring /'char'/ PTR)
...
DECLARE FUNCTION g_io_module_new(BYVAL AS gchar PTR) AS GIOModule PTR
...
TYPE _GIconIface
  ...
  to_tokens AS FUNCTION CDECL(BYVAL AS GIcon PTR, BYVAL AS zstring /'char'/ PTR PTR, BYVAL AS gint PTR) AS gboolean
...
TYPE _GMountOperationClass
  ...
  show_processes AS SUB CDECL(BYVAL AS GMountOperation PTR, BYVAL AS const gchar PTR, BYVAL AS gchar PTR PTR, BYVAL AS const gchar PTR)
...
DECLARE FUNCTION g_settings_schema_source_new_from_directory(BYVAL AS gchar PTR, BYVAL AS GSettingsSchemaSource PTR, BYVAL AS gboolean, BYVAL AS GError PTR PTR) AS GSettingsSchemaSource PTR
...
DECLARE SUB g_subprocess_launcher_set_cwd(BYVAL AS GSubprocessLauncher PTR, BYVAL AS gchar PTR)
...
DECLARE SUB g_subprocess_launcher_set_stderr_file_path(BYVAL AS GSubprocessLauncher PTR, BYVAL AS gchar PTR)
DECLARE SUB g_subprocess_launcher_set_stdin_file_path(BYVAL AS GSubprocessLauncher PTR, BYVAL AS const gchar PTR)
DECLARE SUB g_subprocess_launcher_set_stdout_file_path(BYVAL AS GSubprocessLauncher PTR, BYVAL AS gchar PTR)
...
DECLARE FUNCTION g_tls_certificate_new_from_file(BYVAL AS gchar PTR, BYVAL AS GError PTR PTR) AS GTlsCertificate PTR
DECLARE FUNCTION g_tls_certificate_new_from_files(BYVAL AS gchar PTR, BYVAL AS gchar PTR, BYVAL AS GError PTR PTR) AS GTlsCertificate PTR
...
DECLARE FUNCTION g_tls_certificate_list_new_from_file(BYVAL AS gchar PTR, BYVAL AS GError PTR PTR) AS GList PTR
...
DECLARE FUNCTION g_tls_client_connection_get_accepted_cas(BYVAL AS GTlsClientConnection PTR) AS gpointer
...
DECLARE FUNCTION g_tls_database_lookup_certificates_issued_by(BYVAL AS GTlsDatabase PTR, BYVAL AS gpointer, BYVAL AS GTlsInteraction PTR, BYVAL AS GTlsDatabaseLookupFlags, BYVAL AS GCancellable PTR, BYVAL AS GError PTR PTR) AS GList PTR
DECLARE SUB g_tls_database_lookup_certificates_issued_by_async(BYVAL AS GTlsDatabase PTR, BYVAL AS gpointer, BYVAL AS GTlsInteraction PTR, BYVAL AS GTlsDatabaseLookupFlags, BYVAL AS GCancellable PTR, BYVAL AS GAsyncReadyCallback, BYVAL AS gpointer)
...
TYPE _GTlsDatabaseClass
  ...
  lookup_certificates_issued_by AS FUNCTION CDECL(BYVAL AS GTlsDatabase PTR, BYVAL AS gpointer, BYVAL AS GTlsInteraction PTR, BYVAL AS GTlsDatabaseLookupFlags, BYVAL AS GCancellable PTR, BYVAL AS GError PTR PTR) AS GList PTR
  lookup_certificates_issued_by_async AS SUB CDECL(BYVAL AS GTlsDatabase PTR, BYVAL AS gpointer, BYVAL AS GTlsInteraction PTR, BYVAL AS GTlsDatabaseLookupFlags, BYVAL AS GCancellable PTR, BYVAL AS GAsyncReadyCallback, BYVAL AS gpointer)
...
DECLARE FUNCTION g_tls_file_database_new(BYVAL AS gchar PTR, BYVAL AS GError PTR PTR) AS GTlsDatabase PTR
...
DECLARE FUNCTION g_unix_mount_point_get_device_path(BYVAL AS GUnixMountPoint PTR) AS zstring /'char'/ PTR
DECLARE FUNCTION g_unix_mount_point_get_fs_type(BYVAL AS GUnixMountPoint PTR) AS const char PTR
DECLARE FUNCTION g_unix_mount_point_get_mount_path(BYVAL AS GUnixMountPoint PTR) AS zstring /'char'/ PTR
...
DECLARE FUNCTION g_vfs_register_uri_scheme(BYVAL AS GVfs PTR, BYVAL AS const char PTR, BYVAL AS GVfsFileLookupFunc, BYVAL AS gpointer, BYVAL AS GDestroyNotify, BYVAL AS GVfsFileLookupFunc, BYVAL AS gpointer, BYVAL AS GDestroyNotify) AS gboolean
DECLARE FUNCTION g_vfs_unregister_uri_scheme(BYVAL AS GVfs PTR, BYVAL AS const char PTR) AS gboolean
TYPE _GVfsClass
  AS GObjectClass parent_class
...
DECLARE FUNCTION g_io_modules_load_all_in_directory(BYVAL AS gchar PTR) AS GList PTR
DECLARE FUNCTION g_io_modules_load_all_in_directory_with_scope(BYVAL AS gchar PTR, BYVAL AS GIOModuleScope PTR) AS GList PTR
DECLARE SUB g_io_modules_scan_all_in_directory(BYVAL AS zstring /'char'/ PTR)
DECLARE SUB g_io_modules_scan_all_in_directory_with_scope(BYVAL AS gchar PTR, BYVAL AS GIOModuleScope PTR)
...
DECLARE FUNCTION g_unix_is_mount_path_system_internal(BYVAL AS zstring /'char'/ PTR) AS gboolean
...
DECLARE FUNCTION g_unix_mount_get_device_path(BYVAL AS GUnixMountEntry PTR) AS zstring /'char'/ PTR
DECLARE FUNCTION g_unix_mount_get_fs_type(BYVAL AS GUnixMountEntry PTR) AS const char PTR
DECLARE FUNCTION g_unix_mount_get_mount_path(BYVAL AS GUnixMountEntry PTR) AS zstring /'char'/ PTR
