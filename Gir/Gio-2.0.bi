...
DECLARE FUNCTION g_app_info_get_supported_types(BYVAL AS GAppInfo PTR) AS const char PTR PTR
...
TYPE _GAppInfoIface
  ...
  get_supported_types AS FUNCTION CDECL(BYVAL AS GAppInfo PTR) AS const char PTR PTR
...
DECLARE FUNCTION g_desktop_app_info_get_locale_string(BYVAL AS GDesktopAppInfo PTR, BYVAL AS const char PTR) AS zstring /'char'/ PTR
...
DECLARE FUNCTION g_desktop_app_info_get_string_list(BYVAL AS GDesktopAppInfo PTR, BYVAL AS const char PTR, BYVAL AS gsize PTR) AS gchar PTR PTR
...
DECLARE FUNCTION g_file_new_tmp(BYVAL AS const char PTR, BYVAL AS GFileIOStream PTR PTR, BYVAL AS GError PTR PTR) AS GFile PTR
...
DECLARE FUNCTION g_file_peek_path(BYVAL AS GFile PTR) AS const char PTR
...
DECLARE FUNCTION g_file_replace_contents(BYVAL AS GFile PTR, BYVAL AS const char PTR, BYVAL AS gsize, BYVAL AS const char PTR, BYVAL AS gboolean, BYVAL AS GFileCreateFlags, BYVAL AS zstring /'char'/ PTR PTR, BYVAL AS GCancellable PTR, BYVAL AS GError PTR PTR) AS gboolean
DECLARE SUB g_file_replace_contents_async(BYVAL AS GFile PTR, BYVAL AS const char PTR, BYVAL AS gsize, BYVAL AS const char PTR, BYVAL AS gboolean, BYVAL AS GFileCreateFlags, BYVAL AS GCancellable PTR, BYVAL AS GAsyncReadyCallback, BYVAL AS gpointer)
...
TYPE _GMountOperationClass
  ...
  ask_question AS SUB CDECL(BYVAL AS GMountOperation PTR, BYVAL AS const char PTR, BYVAL AS const char PTR PTR)
...
DECLARE FUNCTION g_unix_is_system_device_path(BYVAL AS const char PTR) AS gboolean
DECLARE FUNCTION g_unix_is_system_fs_type(BYVAL AS const char PTR) AS gboolean
...
DECLARE FUNCTION g_unix_mount_for(BYVAL AS const char PTR, BYVAL AS guint64 PTR) AS GUnixMountEntry PTR
...
DECLARE FUNCTION g_unix_mount_get_options(BYVAL AS GUnixMountEntry PTR) AS const char PTR
DECLARE FUNCTION g_unix_mount_get_root_path(BYVAL AS GUnixMountEntry PTR) AS const char PTR
